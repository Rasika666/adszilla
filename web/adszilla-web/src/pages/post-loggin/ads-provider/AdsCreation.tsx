...
import AdsTargetArea, {setAdTargetArea} from "./ads-creation-pages/AdsTargetArea";
...
const AdsCreation = () => {
  ...
  const adsTargetAreaRef = useRef<setAdTargetArea>(null);
  ...
  const handleNext = () => {
    ...
    if (activeStep === 2) adsTargetAreaRef.current?.updateTargetArea();
