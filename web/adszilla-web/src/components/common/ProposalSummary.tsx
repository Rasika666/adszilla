  ...
  return (
    <div className="container">
      <div className="row">
        ...
        <PoposalSummaryCard discription="Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment" />
        ...
        <div className="col-xl-4 col-lg-4">
          <div className="sidebar-container">
            ...
            {userType === UserType.AD_PROVIDER ?
              ...
              <a href="#small-dialog" className="apply-now-button popup-with-zoom-anim margin-bottom-50">Delete poposal </a>
            }
          </div>
        </div>
      ...
      {userType === UserType.AD_PROVIDER ?
        <div className="row">
          ...
          <AboutMe discriptions={Array("Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment",
            ...
            <div className="boxed-list margin-bottom-60">
              ...
              <ul className="boxed-list-ul">
                <BoxListItem title="Seyaln Bank Ad" discription="Reted as freelancer"
                  subDiscription="Excellent programmer - fully carried out my project in a very professional manner." rating="5.0" />
                <BoxListItem title="Seyaln Bank Ad" discription="Reted as freelancer"
                  subDiscription="Excellent programmer - fully carried out my project in a very professional manner." rating="5.0" />
                <BoxListItem title="Seyaln Bank Ad" discription="Reted as freelancer"
                  subDiscription="Excellent programmer - fully carried out my project in a very professional manner." rating="5.0" />
