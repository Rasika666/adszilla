...
import { List, TableRow } from '@mui/material';
  ...
  return (
    <div className="container">
      <div className="row">
        ...
        <ProposalSummaryCard description="Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment" />
        ...
        <div className="col-xl-4 col-lg-4">
          <div className="sidebar-container">
            ...
            {userType === UserType.AD_PROVIDER ?
              <div>
                <a href="#small-dialog" className="apply-now-button popup-with-zoom-anim margin-bottom-50">Approve </a>
                <a href="#small-dialog" className="apply-now-button popup-with-zoom-anim margin-bottom-50">Reject </a>
              </div> :
              <a href="#small-dialog" className="apply-now-button popup-with-zoom-anim margin-bottom-50">Delete proposal </a>
            }
          </div>
        </div>
      ...
      {userType === UserType.AD_PROVIDER ?
        <div className="row">
          ...
          <AboutMe description={Array("Leverage agile frameworks to provide a robust synopsis for high level overviews. Iterative approaches to corporate strategy foster collaborative thinking to further the overall value proposition. Organically grow the holistic world view of disruptive innovation via workplace diversity and empowerment",
            ...
            <div className="boxed-list margin-bottom-60">
              ...
              <ul className="boxed-list-ul">
                <BoxListItem title="Seyaln Bank Ad" description="Rated as freelancer"
                  subDescription="Excellent programmer - fully carried out my project in a very professional manner." rating="5.0" />
                <BoxListItem title="Seyaln Bank Ad" description="Rated as freelancer"
                  subDescription="Excellent programmer - fully carried out my project in a very professional manner." rating="5.0" />
                <BoxListItem title="Seyaln Bank Ad" description="Rated as freelancer"
                  subDescription="Excellent programmer - fully carried out my project in a very professional manner." rating="5.0" />
