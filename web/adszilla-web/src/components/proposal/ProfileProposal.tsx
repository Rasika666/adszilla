...
const ProfileProposal: FC<ProfileProposalProps> = ({proposal}) => {
          ...
          <div className="freelancer-overview-inner">
            ...
            <div className="freelancer-name">
              ...
              <p className="freelancer-detail-item">
                <Link to={`/ad-details/${ad?.id}/provider/profile`}><i className="icon-brand-adversal"></i>{ad?.id} </Link>
              </p>
              ...
              <div className="buttons-to-right always-visible margin-top-25 margin-bottom-0">
                ...
                <Link to={`/view-proposal/${proposal.id}`} className="button gray ripple-effect ico" title="view proposal"
